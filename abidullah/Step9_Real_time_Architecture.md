...
⚠️ Nginx WebSocket Timeout
Default Nginx proxy_read_timeout is 60 seconds. WebSocket connections will be cut every 60s silently. Add to Nginx WS location: proxy_read_timeout 86400; — keeps connections alive up to 24 hours.
 
