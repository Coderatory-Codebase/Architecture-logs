...
**Revision 2** — addressed the main architecture gaps that were deferred in the original document and closed the key issues required for implementability, security, and operability.

See §7.1 (Revision Note) in [07-Design-Rationale-and-Summary.md](./07-Design-Rationale-and-Summary.md) for the full rationale.
