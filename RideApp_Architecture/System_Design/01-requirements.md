...
> Source: `Yango_Clone_Architecture.docx` | Version 1.0 — June 2025 — Single-City Launch — Currency: PKR
...
> ⚠️ **Uptime vs Single VPS** — Current plan is single VPS. 99.9% SLA requires max 8.7 hrs downtime/year — provider maintenance alone can exceed this. Either relax NFR to "best effort, single VPS" or plan second instance + load balancer for V1.5.
...
---
◀ Back to [README](../README.md) | Next → [02 — System Context](02-system-context.md)
